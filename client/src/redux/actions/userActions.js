...
import { setUserOrders, setError, setLoading, setServerResponseMsg, setServerResponseStatus, userLogin, userLogout, verificationEmail, stateReset } from '../slices/user';
...
export const login = (email, password) => async (dispatch) => {
    ...
    try {
       ...
       localStorage.setItem('userInfo', JSON.stringify(data));  //saving the login info.even if u referesh the page the u will be log in .
    } catch (error) {
        dispatch(
            setError(
...
//Program for sending to reset the Email:
